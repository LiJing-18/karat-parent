package com.example.generating.po;
...
public class TableInfo {
    ...
    @Getter @Setter
    private List<TableField> voFields = Lists.newArrayList();
    @Getter @Setter
    private List<TableField> addFields = Lists.newArrayList();
    @Getter @Setter
    private List<TableField> updateFields = Lists.newArrayList();
    @Getter @Setter
    private List<TableField> searchFields = Lists.newArrayList();
