package com.example.generating.engine;

import com.baomidou.mybatisplus.generator.config.*;
import com.baomidou.mybatisplus.generator.config.rules.DbColumnType;
import com.example.generating.builder.ConfigBuilder;
import com.example.generating.config.TempConfig;
import com.example.generating.po.TableInfo;
import com.example.generating.util.BaseFieldUtil;
import com.example.generating.util.StrKit;
import com.example.generating.util.ToolUtil;
...
//            tempConfig.setEnBigName(ToolUtil.firstLetterToUpper(tableInfo.getEntityName().replace("_","")));
     ...
     * @param config
     */
    public static void addHansFrameworBeetlkImport(TempConfig config) {
        // Controller import配置
        config.getControllerImports().add("hans.framework.core.exception.ParameterMissException");
        config.getControllerImports().add("hans.framework.core.persistence.ResponseVo");
        config.getControllerImports().add("hans.framework.core.persistence.dto.BaseDto");
        config.getControllerImports().add("hans.framework.core.persistence.dto.IdsDto");
        config.getControllerImports().add("hans.framework.core.persistence.web.BaseController");
        config.getControllerImports().add("hans.framework.core.aspect.Log");

        // Service import配置
        config.getServiceImports().add("hans.framework.core.persistence.ResponseVo");
        config.getServiceImports().add("hans.framework.core.persistence.Service.BaseService");

        // Entity import配置
        config.getEntityImports().add("hans.framework.core.persistence.entity.DataEntity");

        // Vo import配置
        config.getVoImports().add("hans.framework.core.persistence.dto.BaseVo");
        // insert import配置
        ...
        // update import配置
        config.getUpdateImports().add("hans.framework.core.persistence.dto.BaseDto");
        ...
        // Search import配置
        config.getSearchImports().add("hans.framework.core.persistence.dto.BasePageDto");

        // Dao import配置
        config.getDaoImports().add("hans.framework.core.persistence.dao.BaseDao");
    }

    public static void addHansFrameworMybatieskImport(TempConfig config) {
        // Controller import配置
        config.getControllerImports().add("hans.framework.core.exception.ParameterMissException");
        config.getControllerImports().add("hans.framework.core.persistence.ResponseVo");
        config.getControllerImports().add("hans.framework.core.persistence.dto.BaseDto");
        ...
        config.getControllerImports().add("hans.framework.core.persistence.web.BaseController");
        config.getControllerImports().add("hans.framework.core.aspect.Log");
        config.getControllerImports().add("hans.framework.core.persistence.entity.PageInfo");

        // Service import配置
        config.getServiceImports().add("hans.framework.core.persistence.service.CrudService");
        ...
        // Dao import配置
        config.getDaoImports().add("hans.framework.core.persistence.dao.CrudDao");
    }
